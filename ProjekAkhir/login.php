        ...
        <ul class="uk-navbar-nav">
            ...
            <?php
                if(empty($_SESSION["username"])){
                    echo "<li><a href='#' style='color:white'>Lihat Jadwal Service</a></li>";
                }elseif(isset($_SESSION["username"])){
                    echo "<li><a href='#' style='color:white'>Reservasi Jadwal Service</a></li>";
                    ...
                    <ul class="uk-nav uk-navbar-dropdown-nav">
                        <?php
                            if(empty($_SESSION["username"])){
                                ...
                                echo "<li class='uk-active'><a href='admin/index.php'>Login Admin</a></li>";
                            }elseif(isset($_SESSION["username"])){

        ...
        <ul class="uk-navbar-nav">
            ...
            <?php
                if(empty($_SESSION["username_adm"])){
                    ...
                    echo "<li><a href='#' style='color:white'>Jadwal Reservasi</a></li>";//admin_jadwal_reservasi.php
                    echo "<li><a href='#' style='color:white;'>Block User</a></li>";//admin_block_user.php
                    echo "<li><a href='#' style='color:white;'>Lihat Rekapan Jumlah</a></li>";//admin_jumlah.php
                }
            ?>
        </ul>
    </div>
